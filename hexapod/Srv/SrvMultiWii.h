...
#define MSP_PREAMBLE             "$M"  //preamble of multiwii msg
#define MSP_DIRECTION_OUT        '>'   //direction of multiwii msg
#define MSP_DIRECTION_IN         '<'   //direction of multiwii msg
