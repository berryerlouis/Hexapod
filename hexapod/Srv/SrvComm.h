...
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_TRANSLATION_XYZ	0x02U   //set translation x y z
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_POSITION_XYZ		0x03U   //set roll pitch yaw on body
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_WALK				0x04U   //set walk
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_GAIT				0x05U   //set gait
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_AMPLITUDE			0x06U   //set amplitude
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_GROUND_SIZE		0x07U   //set ground size
#define COMM_CLUSTER_BEHAVIOR_COMMAND_SET_ELEVATION			0x08U   //set elevation
